...
def hot_condition():
    print("Chances of Stampede (Keep a security personal ready!)")
...
while True:
    ...
    faces = face_cascade.detectMultiScale(grayImage, 1.002)
    if len(faces) != 0:
        s = None
        print(hour)
        print(faces.shape[0])
            ...
            if faces.shape[0] >= 0:
                if faces.shape[0] < 100:
                    ...
                    if faces.shape[0] < 200:
                        ...
                        if faces.shape[0] < 300:
                            s = 'WARM'
                        elif faces.shape[0] >= 300:
                            s = 'HOT'
                            hot_count = hot_count + 1
        print(s)
